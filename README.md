...
There is no Linux version yet, but since we are using JUCE it should be _relative simple_. I actually did a quick test of this, by building A8Manager, back in 2023 and published the results in a youtube video.
