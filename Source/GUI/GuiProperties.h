...
public:
    ...
    void setActiveTab (int tabIndex, bool includeSelfCallback);
    // 0.0 is the near-black scheme, 1.0 a white one
    ...
    static inline const juce::Identifier ActiveTabPropertyId { "activeTab" };
